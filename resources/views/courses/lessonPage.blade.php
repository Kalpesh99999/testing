...
@section('body')
    <div class="container-fluid" style="padding:0px; background-color:#F1F1F1">
        ...
        <div class="row" id="page-container">
            <div class="col col-md-9" id="main-col">

                <div class="embedHolder1" id="embedHolder">
                    <div class="embed-responsive embed-responsive-16by9" id="course_desc" style="display: none">

                    </div>
                </div>
                <div class="textholder" id="lesson_desc">
                ...
                <div class="textholder" id="lesson_author">
                    <div class="row">
                        <div class="col-sm-3">
