...
@section('body')
    ...
    <div class="container-fluid" id="page-container" style="padding:0px; background-color:#F1F1F1">
        ...
        <div class="section text-center bg-success p-4 my-5">
            <div class="row">
                <div class="col-12">
                    <h1 class="text-white" id="page-heading">{{$oem_name_slug->Name}} Training Courses</h1>
                ...
                <input type="hidden" id="course-id" value={{$oem_name_slug->id}}>
            </div>
        </div>
        <div class="row">
...
<script>
    ...
    $(document).ready(function() {
        ...
        var res = x.split("/");
        var course_name= $('#course-id').val().trim();
      //
        //var sites =json_encode($oemName->toArray());

        $.ajax({
            url: '/api/getOEMCourses/'+ course_name,
            type: 'POST',
            datatype: JSON,
            success: function (response) {
                ...
                $.each(response.data, function (index,value){
                    ...
                    newDiv.href='/courses/'+res[2]+'/'+value.id;
